...
class DeviceDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.label_7.setGeometry(QtCore.QRect(360, 130, 145, 31))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_5.setText("小板数量")
        self.label_6.setText("工作模式")
        self.label_7.setText("每小时目标产量")
        ...
        self.confirmButton.setGeometry(300,360,50,50)
    ...
    def confirmButtonClicked(self):
        self.productModel=self.lineEdit_3.text()
        self.productMulti=self.lineEdit_4.text()
        self.hourProduction=self.lineEdit_6.text()
        _yamlTool=Yaml_Tool()
        params=_yamlTool.getValue("configure.yaml")
        params['devices'][self.deviceSerial]['productModel']=self.productModel
        params['devices'][self.deviceSerial]['productMulti']=int(self.productMulti)
        params['devices'][self.deviceSerial]['hourProduction']=int(self.hourProduction)
        _yamlTool.saveParam("configure.yaml",params)
        print(self.deviceSerial)
        self.close()

    def dataIni(self,_device):
        _nullData="null"
        _yamlTool=Yaml_Tool()
        params=_yamlTool.getValue("configure.yaml")
        params['devices'][_device]
        self.deviceSerial=_device
        self.productModel=params['devices'][_device]['productModel']
        self.productMulti=params['devices'][_device]['productMulti']
        self.hourProduction=params['devices'][_device]['hourProduction']
        self.ip=params['devices'][_device]['ip']
        self.firmWareVersion=params['devices'][_device]['firmWareVersion']
        ...
        self.lineEdit_4.setText(str(self.productMulti))

        # self.lineEdit_5.setReadOnly(True)
        # self.lineEdit_5.setText(str(self.state))

        # self.lineEdit_6.setReadOnly(True)
        self.lineEdit_6.setText(str(self.hourProduction))
