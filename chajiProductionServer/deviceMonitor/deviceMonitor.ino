...
//  String serverIp = "192.168.16.107";
  //  String ssid = "NETGEAR";
  //  String ssidPasswd = "sj13607071774";
  //  String serverIp = "10.0.0.3";
  //
  String ssid = "CHAJI_CALCULATE";
  String ssidPasswd = "JX_TELUA";
...
void calculateAddNum() {
  unsigned int productedNum = productParam.productedNum2 * 255 + productParam.productedNum1 + 1;
  if (client.connected()) 
  {
    sendMsg(msgParam.calculateMsg + String(productedNum));
    if (productParam.productedNum2 != 0 || productParam.productedNum1 != 0) {
      EEPROM.write(productParam.productedNumAddress1, 0);
      delay(30);
      EEPROM.write(productParam.productedNumAddress2, 0);
      delay(30);
  ...
  else
  {
    ...
    if (productParam.productedNum1 > 10) 
    {
      ESP.restart();
    }
  }
